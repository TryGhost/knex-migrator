                ...
                return self.runDatabaseUpgrades().then(function () {
                    return self.lock()
                        ...
                        .then(function () {
                            ...
                            /**
                             * CASE 1: You can disable init completetion manually
...
KnexMigrator.prototype.rollback = function rollback(options) {
    ...
    const helper = function helper() {
        return new Promise(function (resolve, reject) {
            ...
            // CASE 1: rollback to specific version
            // CASE 2: rollback current version you are on (query all and filter out)
            if (version) {
