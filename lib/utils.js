...
/**
 * Reads all migration files from disk based on a path.
...
/**
 * Reads all version folders from disk in correct order.
 *
 * @param absolutePath
 * @returns {*}
 */
...
/**
 * A helper function to figure out if a version is greater than another version.
 *
 * Valid versions are:
 * - 1
 * - 1.1
